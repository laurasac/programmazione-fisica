...
void createGraph(sf::RenderWindow& window, const int width, const int height,
                 const int margin, std::vector<sir::SIR> state, int T, int N,
                 sf::Font& font);
void createChart(sf::RenderWindow& window, const int width, const int height,
                 const int margin, int T, int N, sf::Font& font);
void printMap(sf::RenderWindow& window, std::vector<char> map, sir::SIR state,
              int size, int width, int height, int margin, sf::Font& font);
